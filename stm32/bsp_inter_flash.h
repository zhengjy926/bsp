/**
  ...
  * @file        : bsp_inter_flash.h
  * @author      : ZJY
  * @version     : V1.0
  * @date        : 2025-10-16
  * @brief       : STM32 INTERFLASH driver header file
  * @attention   : None
  ******************************************************************************
  * @history     :
  *         V1.0 : 1.Initial version of INTERFLASH driver
  *
  *
  ******************************************************************************
  */
#ifndef BSP_INTER_FLASH_H__
#define BSP_INTER_FLASH_H__
...
int32_t BSP_InterFlash_EraseChip(void);
bool    BSP_InterFlash_IsErased(uint32_t addr, uint32_t len);

#ifdef __cplusplus
}
#endif /* __cplusplus */

#endif /* BSP_INTER_FLASH_H__ */
